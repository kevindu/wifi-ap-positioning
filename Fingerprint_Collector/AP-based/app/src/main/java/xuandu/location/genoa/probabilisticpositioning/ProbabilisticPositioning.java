package xuandu.location.genoa.probabilisticpositioning;

/**
 * Created by xuandu on 18/06/2017.
 */
...
public class ProbabilisticPositioning {
    ...
    public ProbabilisticPositioning(Context context, String _path) {
    ...
    /** Write the RadioMap in a format suitable for the <i>savePowerLog()</i> function.
     * @throws IOException **/
    public void save() throws IOException{

        System.out.print("Start writing the RadioMap....");

        File pdata = new File(DIRECTORY_TO_RADIOMAP);
        ...
        File file = new File(DIRECTORY_TO_RADIOMAP, "radiomap.txt");
        OutputStreamWriter outputStreamWriter = new OutputStreamWriter(new FileOutputStream(file));

        // Write the number of AP
        outputStreamWriter.write(numAP + "\n");

        // Write the number of RP
        outputStreamWriter.write(numRP + "\n");
        ...
        for (int i = 0; i < numRP; i++) { //rows
            ...
            outputStreamWriter.write(_sj.toString() + "\n");
